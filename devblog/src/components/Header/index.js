...
import { Wrapper, Buttons, Content } from './Header.styles';
    ...
    <Wrapper>
        <Container fluid>
            <Row>
                ...
                <Col xs={12} md={11} className="align-self-center">
                    <Buttons>
                        <a>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="White" class="bi bi-translate" viewBox="0 0 16 16">
